...
(async () => {
  ...
  // console.log(
  //   "Transaction Detail: ",
  //   await supraClient.getTransactionDetail(senderAccount.address().toString(),txResData.txHash)
  // );
  ...
  console.log(
    ...
    await supraClient.getCoinTransactionsDetail(senderAccount.address(), 5)
  );
})();
